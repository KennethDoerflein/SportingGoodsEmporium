        ...
        <div class="container">
            ...
            <div class=" form-group row mb-2">
                ...
                <div class=" form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <input required  type="password" class="form-control" id="repassword" 
                            placeholder="Reenter Password" name="repassword">
                    </div>
                </div>
                ...
                <div class=" form-group row mb-2">
                    ...
                    <div class="col-sm-10">
                        <input required  type="text" class="form-control" id="phone_num" 
                            placeholder="999-999-9999" name="phoneNum" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
                    </div>
                </div>
